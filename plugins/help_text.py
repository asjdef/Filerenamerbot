    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/sl_media_tech'),
                    InlineKeyboardButton('Feedback', url='https://t.me/Akilawiduruwan')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/SL_MEDIA_TECH_GRUOP'),
                    InlineKeyboardButton('Nova Technology', url='https://t.me/NovaTechlk')
                ]
            ]
        ),
